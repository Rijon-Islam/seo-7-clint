                                ...
                                <>
                                    {
                                        footersocial.map(c =>
                                            footersocial.map(c =>
                                                <Link className='theme-btn-one border0 ripple-btn' to={`/edit-social-footer/${c._id}`}> Edit Social URL </Link>)
                                ...
                                <form class="contact-form " onSubmit={handleFootersocial}>
                                    <div class="row">
                                        ...
                                        <div class="slider-btn">
                                            <button class="theme-btn-one border0 ripple-btn" data-delay=".8s"> Add Footer Social </button>
                                        </div>
                                    </div>
