    ...
    return (
        ...
        <div className='mt-5'>
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-8 col-md-12">
                        ...
                        <h3 className='mt-5'> Update Testimonial Text </h3>
                        {
                            ...
                            <>
                                {testimonialtext.map(text =>
                                    <Link className='theme-btn-one border0 ripple-btn' to={`/testimonialtext-edit/${text._id}`}> Update Now</Link>
                                )}
                            </>
                        }
                                ...
                                <div class="row mb-100">
                                    ...
                                    <div className="col-lg-12 col-md-12 mb-3">
                                            <div className="form-group">
                                                <input type="text" className="form-control" name="testimonialText" placeholder="Testimonial Text" required />
                                            </div>
                                        </div>
                                    <div className="col-lg-12 col-md-12 mb-3">
                                            <div className="form-group">
                                                <input type="text" className="form-control" name="testimonialHeading" placeholder="Testimonial Heading" required />
                                            </div>
                                        </div>
                                    ...
                                    <div class="slider-btn">
                                        <button class="theme-btn-one border0 ripple-btn" data-animation="fadeInRight" data-delay=".8s"> Update Testimonial Text </button>
                                    </div>
                                </div>
                        ...
                        <h3 className='mt-100'> Add Testimonial Item </h3>
                        ...
                        <form class="contact-form " onSubmit={handleStepSection}>
                            <div class="row">
                                ...
                                <div class="slider-btn">
                                    <button class="theme-btn-one border0 ripple-btn" data-delay=".8s"> Add Testimonial</button>
                                </div>
                            </div>
            ...
            <div className="container">
                ...
                <Link to={`/edit-testimonial/${e._id}`} className='theme-btn-one border0 ripple-btn'>Testimonial Pricing</Link>
