                ...
                <div className='text-center'> {/* Center-align the content */}
                    ...
                    <form onSubmit={handlePaymentStatus} className="text-center"> {/* Center-align the form */}
                        ...
                        <div class="slider-btn">
                            <button class="theme-btn-one border0 ripple-btn" data-animation="fadeInRight" data-delay=".8s"> Update Payment </button>
                        </div>
                    </form>

                    <h3 className='mt-5'>Update Order Status</h3>
                    ...
                    <form onSubmit={handleOrderStatus} className="text-center"> {/* Center-align the form */}
                        ...
                        <div class="slider-btn">
                            <button class="theme-btn-one border0 ripple-btn" data-animation="fadeInRight" data-delay=".8s"> Update Order </button>
                        </div>
                    </form>
