...
import call from './Images/calltoaction.png'
                       ...
                       <div class="container text-center">
                           <div class="row">
                               ...
                               <div class="col-lg-3  col-md-6 col-12">
                                   ...
                                   <div className='single-card'>
                                       <Link to='/edit-faq'> <img src={features} />Why Choose</Link>
                                   </div>
                               </div>
                               <div class="col-lg-3  col-md-6 col-12">
                                   <div className='single-card'>
                               ...
                               <div class="col-lg-3  col-md-6 col-12">
                                   <div className='single-card'>
                                       <Link to='/edit-experience'><img src={quality} /> Exprence Setting</Link>
                                   </div>
                               ...
                               <div class="col-lg-3  col-md-6 col-12">
                                   <div className='single-card'>
                                       <Link to='/update-calltoaction'><img src={call} /> Call  to Setting</Link>
                                   </div>
                               ...
                               <div class="col-lg-3  col-md-6 col-12">
                                   ...
                                   <div className='single-card'>
                                       <Link to='/add-social-footer'> <img src={footersocial} /> Footer Social Link</Link>
                                   </div>
                               </div>
