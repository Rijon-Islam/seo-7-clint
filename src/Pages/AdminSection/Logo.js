                                ...
                                <>
                                    {
                                        logo.map(c =>
                                            logo.map(c =>
                                                <Link className='theme-btn-one border0 ripple-btn' to={`/edit-logo/${c._id}`}> Please Edit Your Logo</Link>)
                                ...
                                <form class="contact-form " onSubmit={handleLogo}>
                                    ...
                                    <div className="col-lg-12 col-md-12 mb-3">
                                        ...
                                        <div class="slider-btn">
                                            <button class="theme-btn-one border0 ripple-btn" data-animation="fadeInRight" data-delay=".8s">Update Your Logo</button>
                                        </div>
                                    </div>
