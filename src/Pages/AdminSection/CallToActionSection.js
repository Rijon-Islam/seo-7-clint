                                    ...
                                    <>
                                        {
                                            ...
                                            action.map(c =>
                                                <Link className='theme-btn-one border0 ripple-btn' to={`/edit-call/${c._id}`}> Edit Call To Action</Link>)
                                    ...
                                    <form class="contact-form " onSubmit={handleActionSection}>
                                        <div class="row">
                                            ...
                                            <div class="slider-btn">
                                                <button class="theme-btn-one border0 ripple-btn" data-animation="fadeInRight" data-delay=".8s">Add Call To Action</button>
                                            </div>
                                        </div>
