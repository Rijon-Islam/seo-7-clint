                            ...
                            <div class="col-lg-8 col-md-12">
                                ...
                                <form class="contact-form " onSubmit={handleBannerSection}>
                                    <div class="row">
                                        ...
                                        <div className="col-lg-12 col-md-12 mb-3">
                                            <div className="form-group">
                                                <input type="text" className="form-control" name="videoLink" defaultValue={banner.videoLink} placeholder="Banner Video URL " required />
                                            </div>
                                        </div>
                                        ...
                                        <div class="slider-btn">
                                            <button class="theme-btn-one border0 ripple-btn" data-animation="fadeInRight" data-delay=".8s">Update Banner</button>
                                        </div>
                                    </div>
