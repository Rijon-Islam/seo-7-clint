                        ...
                        <div class="col-lg-8 col-md-12">
...

                            {
                                ...
                                <>
                                            ...
                                            {users.map(a =>
                                                <Link className='theme-btn-one border0 ripple-btn' to={`/admin-user/${a._id}`}> Update User</Link>)}
                                ...
                                <form class="contact-form " onSubmit={handleUser}>
                                    <div class="row">
                                        ...
                                        <div class="slider-btn ">
                                            <button class="theme-btn-one border0 ripple-btn" data-animation="fadeInRight" data-delay=".8s"> Add User </button>
