                                ...
                                <form class="contact-form " onSubmit={handlePricing}>
                                    <div class="row">
                                        ...
                                        <div class="slider-btn">
                                            <button class="theme-btn-one border0 ripple-btn" data-delay=".8s"> Add Package</button>
                                        </div>
                                    </div>
                                ...
                                <div class="col-md-4 col-sm-6">
                                    <div class="pricingTable">
                                        ...
                                        <div class="pricingTable-signup">
                                            <Link to={`/package-edit/${pri._id}`} className='theme-btn-one border0 ripple-btn'>Edit Pricing</Link>
                                        </div>
                                    </div>
                                </div>
                            )}
