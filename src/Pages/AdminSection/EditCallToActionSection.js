                            ...
                            <div class="col-lg-8 col-md-12">
                                ...
                                <form class="contact-form " onSubmit={handleActionSection}>
                                    <div class="row">
                                        ...
                                        <div className="col-lg-12 col-md-12 mb-3">
                                            <div className="form-group">
                                                <input type="text" className="form-control" name="buttonText" defaultValue={call.buttonText} placeholder="Button Text" required />
                                            </div>
                                        </div>
                                        <div className="col-lg-12 col-md-12 mb-3">
                                            <div className="form-group">
                                                <input type="text" className="form-control" name="buttonLink" defaultValue={call.buttonLink} placeholder="Button Link" required />
                                            </div>
                                        </div>


                                        <div class="slider-btn">
                                            <button class="theme-btn-one border0 ripple-btn" data-animation="fadeInRight" data-delay=".8s">Update Action</button>
                                        </div>
                                    </div>
