                                ...
                                <tr key={index}>
                                    ...
                                    <td>
                                        {order.paymentStatus === 'UnPaid' && (
                                            <Link className='theme-btn-one border0 ripple-btn' to={`/pay-now/${order._id}`}>Pay Now</Link>
                                        )}
                                        {order.paymentStatus === 'Paid' && (
                                            <Link className='theme-btn-one border0 ripple-btn' to='#'>You Have Paid</Link>
                                        )}
                                    </td>
                                </tr>
                            ))}
