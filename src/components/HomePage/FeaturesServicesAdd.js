                            ...
                            <div class="col-lg-8 col-md-12">
                                ...
                                <h3 className='mt-5'> Update Features Services Text </h3>
                                {
                                    ...
                                    <>
                                        {featurestext.map(text =>
                                            <Link className='theme-btn-one border0 ripple-btn' to={`/featurestext-edit/${text._id}`}> Update Now</Link>
                                        )}
                                    </>
                                }
                                    ...
                                    <form class="contact-form " onSubmit={handleFeaturesTextSection}>
                                        <div class="row">
                                            ...
                                            <div class="slider-btn">
                                                <button class="theme-btn-one border0 ripple-btn" data-animation="fadeInRight" data-delay=".8s"> Add Features Text </button>
                                            </div>
                                        </div>
                                ...
                                <form class="contact-form " onSubmit={handleItemSection}>
                                    <div class="row">
                                        ...
                                        <div class="slider-btn">
                                            <button class="theme-btn-one border0 ripple-btn" data-delay=".8s"> Add Features Item</button>
                                        </div>
                                    </div>
                                ...
                                featureitems.map(s => <div className="col-md-6 col-lg-4">
                                    <div className="feature-card wow fadeInUp">
                                        ...
                                        <div className="feature-card_content">
                                            ...
                                            <Link to={`/edit-feature-items/${s._id}`}><h3 className="box-title" class="theme-btn-one border0 ripple-btn">Edit Now</h3></Link>
